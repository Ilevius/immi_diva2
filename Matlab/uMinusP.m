close all;
clc;
fieldName = fileread('C:\Users\tiama\OneDrive\Рабочий стол\IMMI\DIVA2\data\flat\1 upp\fieldname.txt');
waveLength = load('C:\Users\tiama\OneDrive\Рабочий стол\IMMI\DIVA2\data\flat\1 upp\waveLength.txt');
...
figure(f1);
v = load('C:\Users\tiama\OneDrive\Рабочий стол\IMMI\DIVA2\data\flat\1 upp\integral_abs.txt');
dots = v(:, 1)/waveLength;
psi = v(1, 3);
psi = 'R/\lambda, \psi = '+string(psi)+'\circ';
graph1u = v(:, 2);

v = load('C:\Users\tiama\OneDrive\Рабочий стол\IMMI\DIVA2\data\flat\2 wpp\integral_abs.txt');
graph1w = v(:, 2);

graph1 = sqrt(graph1u.^2 + graph1w.^2);


v = load('C:\Users\tiama\OneDrive\Рабочий стол\IMMI\DIVA2\data\flat\1 upp\asymptotics_abs.txt');
graph2u = v(:, 2);
v = load('C:\Users\tiama\OneDrive\Рабочий стол\IMMI\DIVA2\data\flat\2 wpp\asymptotics_abs.txt');
graph2w = v(:, 2);
