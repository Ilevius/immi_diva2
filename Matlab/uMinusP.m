close all;
clc;
fieldName = fileread('C:\Users\tiama\OneDrive\Рабочий стол\IMMI\DIVA2\data\flat\5 usp\fieldname.txt');
...
figure(f1);
v = load('C:\Users\tiama\OneDrive\Рабочий стол\IMMI\DIVA2\data\flat\5 usp\integral_abs.txt');
dots = v(:, 1);
psi = v(1, 3);
psi = 'R, \psi = '+string(psi)+'\circ';
graph1u = v(:, 2);

v = load('C:\Users\tiama\OneDrive\Рабочий стол\IMMI\DIVA2\data\flat\6 wsp\integral_abs.txt');
graph1w = v(:, 2);

graph1 = sqrt(graph1u.^2 + graph1w.^2);


v = load('C:\Users\tiama\OneDrive\Рабочий стол\IMMI\DIVA2\data\flat\5 usp\asymptotics_abs.txt');
graph2u = v(:, 2);
v = load('C:\Users\tiama\OneDrive\Рабочий стол\IMMI\DIVA2\data\flat\6 wsp\asymptotics_abs.txt');
graph2w = v(:, 2);
